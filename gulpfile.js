...
gulp.task('scss-lint', function() {
	gulp
		.src([ sassSrc, '!sass/navigation/_burger.scss', '!sass/base/_normalize.scss' ])
		// Cache this action to prevent watch loop
...
gulp.task('styles', function() {
	...
	var plugins = [ autoprefixer({ grid: true, browsers: [ '>1%' ] }) ];
...
gulp.task('validatehtml', function() {
	return gulp.src([ phpSrc, '!functions.php', '!node_modules/**/*', '!inc/**/*' ]).pipe(
		validatehtml({
