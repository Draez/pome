## pome - A minimalist WordPress starter theme

[![Build Status](https://img.shields.io/travis/digitoimistodude/pome.svg?style=flat-square)](https://travis-ci.org/digitoimistodude/pome) [![GitHub release](https://img.shields.io/github/tag/digitoimistodude/pome.svg?style=flat-square)](https://github.com/digitoimistodude/pome/releases) [![GitHub contributors](https://img.shields.io/github/contributors/digitoimistodude/pome.svg?style=flat-square)]()

pome (or simply *Air*) is designed to be a minimal starting point for a WordPress project at [Digitoimisto Dude Oy](https://www.dude.fi), a Finnish boutique digital agency in the center of Jyväskylä. Theme is based on [_s](https://github.com/automattic/_s).
...
Air had by default a basic WooCommerce support [from version 1.9.2](https://github.com/digitoimistodude/pome/commit/55c539bb9cd2e35fdbfdf4f39a136c542b42b884), and for a while it was been separated to its own repository, [air-woocommerce](https://github.com/digitoimistodude/air-woocommerce) since v2.5.6.
...
3. Open project to Atom (or your preferred editor) and run search and replace pome => yourprojectname
...
5. Create a fork of pome
6. `cd ~/Projects/airdev/content/themes`
7. Fetch your fork with `git clone git@github.com:yourusername/pome.git` (remember to replace yourusername with your actual username)
8. `cd ~/Projects/airdev/content/themes/pome`
...
11. Activate theme - if you are using os x lemp: `cd ~/Projects/airdev && vendor/wp-cli/wp-cli/bin/wp theme activate pome` if [marlin-vagrant](https://github.com/digitoimistodude/marlin-vagrant): `ssh vagrant@10.1.2.4 "cd /var/www/$PROJECTNAME/;vendor/wp-cli/wp-cli/bin/wp theme activate air"`
12. Open whole project to sublime, for example with `subl -n ~/Projects/airdev/content/themes/pome` if you have Sublime Text.
13. Go to back to pome dir with `cd ~/Projects/airdev/content/themes/pome` and then run `gulp watch` and start developing!
...
To install pome to your own development environment, just clone your fork to your theme directory, activate the theme, and make changes. If you make changes to front-end (JS/SCSS), you'll need to use our gulpfile and npm dependencies, so make sure you go through steps 9-10 and 12 above.
...
pome comes with [PHP_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) and [scss-lint](https://github.com/brigade/scss-lint) built inside gulpfile.js. **Please note, you need to configure these separately!**
...
**Theme developers please note:** if you use phpcs in [SublimeLinter as custom standard](https://github.com/ronilaukkarinen/sublime-settings/blob/master/Library/Application%20Support/Sublime%20Text%203/Packages/User/SublimeLinter.sublime-settings#L47) on [dudestack](https://github.com/digitoimistodude/dudestack), you will need extra content/themes/pome subfolders inside theme directory for it to work on both global projects and with pome.
